...
Use the selected web-search skill for public web information only when the missing information is required and public, current, or external.
...
`),
		AllowedTools:           []string{"memory.search", "memory.remember"},
