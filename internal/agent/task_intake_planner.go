...
func turnRouterSchema(request AgentRequest) string {
	...
	requiredProperties := []string{"route", "classification", "taskShape", "level", "estimatedMinutes", "requestedOutputFormats", "requiredEvidence", "siteRequestEvidence", "responseLanguage", "reason", "userFacingReply", "priorTaskReference"}
