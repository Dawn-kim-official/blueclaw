	...
	return VirtualSessionScenario{
		...
		Turns: []VirtualTurn{{
			...
			ExpectedEventCounts: []VirtualEventCount{
				...
				{Name: "tool.calendar.event.add.requested", BodyFragment: "최견본", Count: 1},
				{Name: "tool.calendar.event.add.requested", BodyFragment: "이샘플", Count: 1},
			},
			ExpectedModelContexts: []string{
	...
	return VirtualSessionScenario{
		...
		Turns: []VirtualTurn{{
			...
			ActionResponses: []string{
				...
				actionFinishMessage("웹사이트 프로토타입을 배포했습니다: https://demo.device.example.test", "obs-004:site.app.publish:0"),
			},
		...
		Turns: []VirtualTurn{
			{
				...
				ActionResponses: []string{
					...
					actionFinishMessage("Deployed the simple site: https://demo.device.example.test", "obs-005:site.app.publish:0"),
				},
				ExpectedSelectedSkills: []string{"site-prototype"},
			...
			},
			{
				...
				ActionResponses: []string{
					...
					actionFinishMessage("Updated and redeployed the site: https://demo.device.example.test", "obs-005:site.app.publish:0"),
				},
	...
	return VirtualSessionScenario{
		...
		Turns: []VirtualTurn{{
			...
			ActionResponses: []string{
				...
				actionFinishMessage("사이트를 더 예쁘게 다듬고 다시 배포했습니다: https://demo.device.example.test", "obs-009:site.app.publish:0"),
			},
			ExpectedSelectedSkills: []string{"site-prototype"},
